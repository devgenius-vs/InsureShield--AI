...
document_bp = Blueprint('document_verify', __name__)

# Aadhaar Verification API
@document_bp.route('/verify_aadhaar', methods=['POST'])
def verify_aadhaar():
...
@document_bp.route('/verify_death', methods=['POST'])
def verify_death():
...
# Load Aadhaar verification model
